	...
	<div class="row">
				...
				<div class="modify_search_wp">
					<form role="search" method="get" id="search-cruise-form" action="<?php echo esc_url( home_url( '/' ) ); ?>">
						...
						<div class="form-group">
							<label><?php echo esc_html( 'Cruise name', 'citytours' ) ?></label>
							<input type="text" class="form-control" id="cruise_name" name="s" placeholder="<?php esc_attr_e( 'Optionally type cruise name', 'citytours' ) ?>" value="<?php echo esc_attr( $s ) ?>">
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="numbers-row">
								<input type="text" id="cabins" class="qty2 form-control" name="rooms" value="<?php echo esc_attr( $rooms ) ?>">
							</div>
						</div>
						<div class="form-group">
		...
		<div id="filters_col">
			...
			<div class="collapse" id="collapseFilters">
				...
				<?php if ( ! empty( $ct_options['cruise_star_filter'] ) ) :?>
				<?php $counts_by_star = ct_cruise_get_search_result_count( array( 'by' => 'star', 'price_filter'=>$price_filter, 'rating_filter'=>$rating_filter, 'facility_filter'=>$facility_filter, 'district' => $districts ) ); ?>
				<div class="filter_type">
					...
					<ul class="list-filter star-filter" data-base-url="<?php echo esc_url( remove_query_arg( array( 'star_filter', 'page' ) ) ); ?>" data-arg="star_filter">
						<li><label><input type="checkbox" name="star_filter[]" value="-1"><?php echo esc_html__( 'All Cruises', 'citytours' ) . ' (' . esc_html( array_sum( $counts_by_star ) ) . ')' ?></label></li>
						<?php for ( $i = 5; $i > 0; $i-- ) {
				...
				<?php if ( ! empty( $ct_options['cruise_rating_filter'] ) ) :?>
				<div class="filter_type">
				...
				<?php if ( ! empty( $ct_options['cruise_facility_filter'] ) ) :?>
				<div class="filter_type">
		...
		<div class="col-lg-9 col-md-8">
			...
			<div class="hotel-list <?php if ( $current_view == 'grid' ) echo 'row' ?>">
				<?php ct_get_template( 'hotel-list.php', '/templates/cruise/'); ?>
			</div><!-- hotel-list -->
