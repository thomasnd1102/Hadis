...
<div id="position" class="blank-parallax">
	<div class="container"><ul><li><a href="/" title="Home">Home</a></li><li><a href="/hotel/" title="All Hotels">All Hotels</a></li><li><?php echo $term->name; ?></li></ul></div>
</div><!-- End Position -->
...
<div class="container margin_30">
	...
	<div class="row">
		...
		<div class="box_style_cat">
			<ul id="cat_nav">
				<?php
					echo '<li class="all-types"><a href="https://hanoidiscovery.com/hotel/"><i class="icon_set_1_icon-6"></i>' . esc_html__( 'All hotels', 'citytours' ) . '</a></li>';
					$all_hotel_types = get_terms( 'district', array('hide_empty' => 0) );
					if ( ! empty( $all_hotel_types ) ) :
					foreach ( $all_hotel_types as $each_hotel_type ) {
						$term_id = $each_hotel_type->term_id;
						echo '<li data-term-id="' . esc_attr( $term_id ) . '"><a href="' . esc_url( get_term_link( $each_hotel_type ) ) . '">';
						echo '<i class="icon_set_1_icon-6"></i>';
						echo esc_html( $each_hotel_type->name ) . '</a></li>';
					}
					endif;
				?>
			</ul>
