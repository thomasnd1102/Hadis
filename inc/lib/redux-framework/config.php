...
Redux::setSection( $opt_name, array(
	'title' => __( 'Tnd Settings', 'citytours' ),
	'id'    => 'tnd-settings',
	'icon'  => 'el el-home',
	'fields'     => array(
		array(
			'id'       => 'transfer_thankyou_page',
			'type'     => 'select',
			'title'    => __('Transfer Booking Confirmation Page', 'citytours'),
			'subtitle' => __('This sets the transfer booking confirmation Page. ', 'citytours'),
			'options'  => $options_pages,
		),
		array(
			'id'       => 'golf_thankyou_page',
			'type'     => 'select',
			'title'    => __('Golf Course Booking Confirmation Page', 'citytours'),
			'subtitle' => __('This sets the golf course booking confirmation Page. ', 'citytours'),
			'options'  => $options_pages,
		),
	)
) );
...
Redux::setSection( $opt_name, array(
	'title'      => __( 'Restaurant Settings', 'citytours' ),
	'id'         => 'restaurant-settings',
	'fields'     => array(
		array(
			'id'       => 'restaurant_map_icon',
			'type'     => 'text',
			'title'    => __('Restaurant Map Icon URL', 'citytours'),
			'subtitle'    => __('Set Map Icon URL. <br> Please leave this blank if you want to use default Restaurant Map Icon.', 'citytours'),
			'default'  => '',
		),
		array(
			'title' => __('Restaurant End Section', 'citytours'),
			'id' => 'restaurant_end_section',
			'type' => 'editor'),
		
	)
) );
Redux::setSection( $opt_name, array(
	'title'      => __( 'Transfer Settings', 'citytours' ),
	'id'         => 'transfer-settings',
	'fields'     => array(
		array(
			'title' => __('Transfer End Section', 'citytours'),
			'id' => 'transfer_end_section',
			'type' => 'editor'),
		
	)
) );
Redux::setSection( $opt_name, array(
	'title'      => __( 'Sightseeing Settings', 'citytours' ),
	'id'         => 'sightseeing-settings',
	'fields'     => array(
		array(
			'id'       => 'sightseeing_map_icon',
			'type'     => 'text',
			'required' => array( 'disable_hotel', '=', '0' ),
			'title'    => __('Sightseeing Map Icon URL', 'citytours'),
			'subtitle'    => __('Set Map Icon URL. <br> Please leave this blank if you want to use default Sightseeing Map Icon.', 'citytours'),
			'default'  => '',
		),
		array(
			'title' => __('Sightseeing End Section', 'citytours'),
			'id' => 'sightseeing_end_section',
			'type' => 'editor'),
...
Redux::setSection( $opt_name, array(
	...
	'fields'     => array(
		...
		array(
			'title' => __('Hotel End Section', 'citytours'),
			'id' => 'hotel_end_section',
			'type' => 'editor'),
		),
) );
...
//mycode admin cruise option
Redux::setSection( $opt_name, array(
	'title' => __( 'Cruise', 'citytours' ),
	'id'    => 'cruise-settings',
) );

Redux::setSection( $opt_name, array(
	'title'      => __( 'Cruise Main Settings', 'citytours' ),
	...
	'fields'     => array(
		array(
			'id'       => 'disable_cruise',
			'type'     => 'button_set',
			'title'    => __('Enable/Disable Cruise feature.', 'citytours'),
			'default'  => 0,
			'options'  => array(
				'0' => __( 'Enable', 'citytours' ),
				'1' => __( 'Disable', 'citytours' )
		...
		array(
			...
			'title'    => __('Cruise Cart Page', 'citytours'),
			'subtitle' => __('This sets the base page of your Cruise booking. Please add [cruise_cart] shortcode in the page content.', 'citytours'),
			'options'  => $options_pages,
		),
		array(
			'id'       => 'cruise_checkout_page',
			'type'     => 'select',
			'required' => array( 'disable_cruise', '=', '0' ),
			'title'    => __('Cruise Checkout Page', 'citytours'),
			'subtitle' => __('This sets the Cruise Checkout Page. Please add [cruise_checkout] shortcode in the page content.', 'citytours'),
			'options'  => $options_pages,
		),
		array(
			'id'       => 'cruise_thankyou_page',
			'type'     => 'select',
			'required' => array( 'disable_cruise', '=', '0' ),
			'title'    => __('Cruise Booking Confirmation Page', 'citytours'),
			'subtitle' => __('This sets the cruise booking confirmation Page. Please add [cruise_booking_confirmation] shortcode in the page content.', 'citytours'),
			'options'  => $options_pages,
		),
		array(
			'id'       => 'cruise_thankyou_text_1',
			'type'     => 'text',
			'required' => array( 'disable_cruise', '=', '0' ),
			'title'    => __('cruise Booking Confirmation Text 1', 'citytours'),
			'subtitle' => __('This sets confirmation text1.', 'citytours'),
			'default'  => 'Lorem ipsum dolor sit amet, nostrud nominati vis ex, essent conceptam eam ad. Cu etiam comprehensam nec. Cibo delicata mei an, eum porro legere no. Te usu decore omnium, quem brute vis at, ius esse officiis legendos cu. Dicunt voluptatum at cum. Vel et facete equidem deterruisset, mei graeco cetero labores et. Accusamus inciderint eu mea.',
		),
		array(
			'id'       => 'cruise_thankyou_text_2',
			'type'     => 'text',
			'required' => array( 'disable_cruise', '=', '0' ),
			'title'    => __('cruise Booking Confirmation Text 2', 'citytours'),
			'subtitle' => __('This sets confirmation text2.', 'citytours'),
			'default'  => 'Nihil inimicus ex nam, in ipsum dignissim duo. Tale principes interpretaris vim ei, has posidonium definitiones ut. Duis harum fuisset ut his, duo an dolor epicuri appareat.',
		),
		array(
			'id'       => 'cruise_invoice_page',
			'type'     => 'select',
			'required' => array( 'disable_cruise', '=', '0' ),
			'title'    => __('Invoice Page', 'citytours'),
			'subtitle' => __('You can create a blank page for invoice page. After that please set the page here.', 'citytours'),
		...
		array(
			...
			'type'     => 'switch',
			'required' => array( 'disable_cruise', '=', '0' ),
			'title'    => __('cruise Review On/Off', 'citytours'),
			'default'  => true,
		),
		...
		array(
			...
			'type'     => 'text',
			'required' => array( 'disable_cruise', '=', '0' ),
			'title'    => __('cruise Review Fields', 'citytours'),
			'subtitle'    => __('Set review fields separated by comma.', 'citytours'),
			'default'  => 'Position,Comfort,Price,Quality',
		),
		array(
			'title' => __('Cruise End Section', 'citytours'),
			'id' => 'cruise_end_section',
			'type' => 'editor',
		),
...
Redux::setSection( $opt_name, array(
	'title'      => __( 'Cruise List Page Settings', 'citytours' ),
	'id'         => 'cruise-list-settings',
	'subsection' => true,
	'fields'     => array(
		array(
			'id'       => 'cruise_header_img',
			'type'     => 'media',
			'url'      => true,
			'title'    => __( 'Header Image', 'citytours' ),
			'desc'     => '',
		...
		array(
			'title' => __('Enable Star Rating Filter', 'citytours'),
			'subtitle' => __('Add star rating filter to cruise list page.', 'citytours'),
			'id' => 'cruise_star_filter',
			'default' => true,
			'type' => 'switch'),
		array(
			'title' => __('Enable Price Filter', 'citytours'),
			'subtitle' => __('Add price filter to cruise list page.', 'citytours'),
			'id' => 'cruise_price_filter',
			'default' => true,
			'type' => 'switch'),
		array(
			'id'       => 'cruise_price_filter_steps',
			'required' => array( 'cruise_price_filter', '=', true ),
			'type'     => 'text',
			'title'    => __( 'Price Filter Steps', 'citytours' ),
			'subtitle' => __( 'This field is for price filter steps. For example you can set 50,80,100 to make 4 steps - 0~50, 50~80, 80~100, 100+.', 'citytours' ),
			'default'  => '50,80,100',
		...
		array(
			'title' => __('Enable Review Rating Filter', 'citytours'),
			'subtitle' => __('Add review rating filter to cruise list page.', 'citytours'),
			'id' => 'cruise_rating_filter',
			'default' => true,
			'type' => 'switch'),
		array(
			'title' => __('Enable Facility Filter', 'citytours'),
			'subtitle' => __('Add facility filter to cruise list page.', 'citytours'),
			'id' => 'cruise_facility_filter',
			'default' => true,
			'type' => 'switch'),
		...
		array(
			'id'       => 'cruise_posts',
			'type'     => 'text',
			'title'    => __( 'Cruises per page', 'citytours' ),
			'subtitle' => __( 'Select a number of cruises to show on cruises List Page', 'citytours' ),
			'default'  => '12',
		),
	),
) );
...
// add-on compatibility
$cruise_add_on_settings = apply_filters( 'ct_options_cruise_addon_settings', array() );
if ( ! empty( $cruise_add_on_settings ) ) {
	Redux::setSection( $opt_name, array(
		'title'      => __( 'Cruise Add-On Settings', 'citytours' ),
...
Redux::setSection( $opt_name, array(
	'title'      => __( 'Cruise Email Settings', 'citytours' ),
	...
	'fields'     => array(
		...
		array(
			'title' => __('Booking Confirmation Email Subject', 'citytours'),
			'subtitle' => __( 'Cruise booking confirmation email subject.', 'citytours' ),
			'id' => 'cruise_confirm_email_subject',
			'default' => 'Your booking at [cruise_name]',
			'type' => 'text'),
		array(
			'title' => __('Booking Confirmation Email Description', 'citytours'),
			'subtitle' => __( 'Cruise booking confirmation email description.', 'citytours' ),
		...
		array(
			'title' => __('Administrator Booking Notification Email Subject', 'citytours'),
			'subtitle' => __( 'Administrator Notification Email Subject for Cruise Booking.', 'citytours' ),
		...
		array(
			'title' => __('Administrator Booking Notification Email Description', 'citytours'),
			'subtitle' => __( 'Administrator Notification Email Description for Cruise Booking.', 'citytours' ),
...
Redux::setSection( $opt_name, array(
	...
	'fields'     => array(
		...
		array(
			'title' => __('Tour End Section', 'citytours'),
			'id' => 'tour_end_section',
			'type' => 'editor'),
		),
) );
