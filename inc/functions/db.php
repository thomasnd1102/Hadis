...
if ( ! function_exists( 'ct_create_extra_tables' ) ) {
	function ct_create_extra_tables() {
		...
		if ( $installed_db_ver != CT_DB_VERSION ) {
			...
			$sql = "CREATE TABLE " . CT_CRUISE_VACANCIES_TABLE . " (
						id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
						date_from date DEFAULT '0000-00-00',
						date_to date DEFAULT '9999-12-31',
						...
						price_2d1 decimal(16,2) DEFAULT '0.00',
						price_3d2 decimal(16,2) DEFAULT '0.00',
						price_per_child decimal(16,2) DEFAULT '0.00',
						other text,
						PRIMARY KEY  (id)
					) DEFAULT CHARSET=utf8;";
			...
			$sql = "CREATE TABLE " . CT_CRUISE_BOOKINGS_TABLE . " (
						id bigint(20) unsigned NOT NULL AUTO_INCREMENT,
						cruise_id bigint(20) unsigned DEFAULT NULL,
						cabin_type_id bigint(20) unsigned DEFAULT NULL,
