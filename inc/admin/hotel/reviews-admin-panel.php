...
if ( ! function_exists( 'ct_review_calculate_rating' ) ) {
	function ct_review_calculate_rating( $post_id ) {
		...
		} elseif ( 'cruise' == $post_type ) {
			$review_fields = array( "Comfort", "Tourist guide", "Price", "Quality" );
		} elseif ( 'transfer' == $post_type ) {
			$review_fields = array( "Service", "Driver", "Vehicle", "Price" );
		} elseif ( 'restaurant' == $post_type ) {
			$review_fields = array( "Service", "Quality", "Position", "Price" );
		} elseif ( 'golf_course' == $post_type ) {
			$review_fields = array( "Comfort", "Tourist guide", "Price", "Quality" );
		}
		$rating_detail = array();
