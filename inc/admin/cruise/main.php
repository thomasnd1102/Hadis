...
require_once( CT_INC_DIR . '/admin/cruise/vacancies-admin-panel.php' );
require_once( CT_INC_DIR . '/admin/cruise/orders-admin-panel.php' );
//require_once( CT_INC_DIR . '/admin/cruise/reviews-admin-panel.php' );
 ...
 */
if ( ! function_exists( 'ct_cruise_get_room_list' ) ) {
	function ct_cruise_get_room_list( $post_id=0, $def_room_id=0 ) {
...
add_action( 'wp_ajax_cruise_get_hotel_room_list', 'ct_ajax_cruise_get_hotel_room_list' );
