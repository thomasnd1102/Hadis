...
if ( ! function_exists( 'ct_tour_calc_tour_price' ) ) {
	function ct_tour_calc_tour_price( $post_id, $date='', $adults=1, $kids=0, $type='' ) {
		$person_price = get_post_meta( $post_id, '_tour_price', true );
		$price_1 = get_post_meta( $post_id, '_tour_price_1', true );
		$price_2 = get_post_meta( $post_id, '_tour_price_2', true );
		$price_3 = get_post_meta( $post_id, '_tour_price_3', true );
		$price_4 = get_post_meta( $post_id, '_tour_price_4', true );
		$price_5 = get_post_meta( $post_id, '_tour_price_5', true );
		$price_6 = get_post_meta( $post_id, '_tour_price_6', true );
		$price_7 = get_post_meta( $post_id, '_tour_price_7', true );
		$price_8 = get_post_meta( $post_id, '_tour_price_8', true );
		$price_9 = get_post_meta( $post_id, '_tour_price_9', true );
		$price_10 = get_post_meta( $post_id, '_tour_price_10', true );
		...
		if ( $loai_tour == 1 ) {
			switch ( $paxs ) {
				case 1:
					$person_price = $price_1;
					break;
				case 2:
					$person_price = $price_2;
					break;
				case 3:
					$person_price = $price_3;
					break;	
				case 4:
					$person_price = $price_4;
					break;
				case 5:
					$person_price = $price_5;
					break;	
				case 6:
					$person_price = $price_6;
					break;	
				case 7:
					$person_price = $price_7;
					break;	
				case 8:
					$person_price = $price_8;
					break;	
				case 9:
					$person_price = $price_9;
					break;	
				default:
					$person_price = $price_10;
					break;
			}
			$total = $person_price * $adults + 0.75 * $kids * $person_price;
		} 
		elseif ( $loai_tour == 0 ) {
			$total = $person_price * $adults + $child_price * $kids;
		}
		elseif ( $loai_tour == 2 ) {
			if ( $type == 1) { $total = $person_price * $adults + $child_price * $kids;}
			elseif ( $type == 2) {
				switch ( $paxs ) {
					case 1:
						$person_price = $price_1;
				...
				$total = $person_price * $adults +  $kids * $child_price;
			}
		}
		return $total;
	}
