...
$per_page = 10;
$args = array( 'post_type' => 'restaurant', 'posts_per_page' => $per_page, 'paged'=>$page );
$loop = new WP_Query( $args );

?>

<div id="position" class="blank-parallax">
    <div class="container"><ul><li><a href="/" title="Home">Home</a></li><li>All Hanoi Restaurants</li></ul></div>
</div><!-- End Position -->

<div class="container margin_30">
    <div class="main_title">
        <h1><b>Hanoi Restaurants</b></h1>
    </div>
    <div class="row">
        <aside class="col-lg-3 col-md-3">
        	<div class="box_style_cat">
	            <ul id="cat_nav">
	                <?php
	                    echo '<li class="all-types"><a href="https://hanoidiscovery.com/restaurant/" class="active"><i class="icon_set_1_icon-51"></i>' . esc_html__( 'All Restaurants', 'citytours' ) . '<small></small></a></li>';
