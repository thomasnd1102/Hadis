...
<div class="row">
	<div class="col-md-8">
		...
		<div class="step">
			...
			<tr>
				<td><strong><?php echo esc_html__( 'Package', 'citytours' ) ?></strong></td>
				<td><?php echo $order_data['other']; ?></td>
			</tr>
			<?php endif; ?>
			<tr>
				<td><strong><?php echo esc_html__( 'Duration', 'citytours' ) ?></strong></td>
				<td><?php echo get_post_meta( $order_data['post_id'], _tour_duration, true ) ?></td>
			</tr>
			<tr>
